...
\hyphenation{Listagem-Afastamento}
\hyphenation{Afastamento-Controller}
...
\newcommand{\patricia}[1]{\todo[author=\textbf{Patrícia},color=yellow!30,caption={},inline]{#1}}
\newcommand{\clarete}[1]{\todo[author=\textbf{Clarete},color=orange!30,caption={},inline]{#1}}
...
\begin{folhadeaprovacao}
  \begin{center}
    ...
    \vspace*{\fill}
   \end{center}
   Trabalho aprovado. \imprimirlocal, 05 de Julho de 2024:
   \assinatura{\textbf{\imprimirorientador} \\ Orientador} 
   \assinatura{\textbf{Prof. Dra. Patrícia Dockhorn Costa} \\ Universidade Federal do Espírito Santo}
   \assinatura{\textbf{Clarete Aparecida Diniz Gomes} \\ Universidade Federal do Espírito Santo}
...
\include{capitulos/ch3-especificao-requisitos}
