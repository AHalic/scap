...
\clarete{Acho que vale colocar a figura 4 num lugar melhor, ficou no outro subtítulo. 
Isso acontece em outras figuras também,acho que vale uma atenção.}
...
\clarete{Na figura não traz a informação de ser subchefe}
\sophie{A tabela de atores traz essa informação}
