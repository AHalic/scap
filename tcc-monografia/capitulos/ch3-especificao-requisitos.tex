...
\sophie{A figura foi refeita a partir do diagrama de classes de \cite{prado:2015}, só alterando as cores e a propriedade é chefe em Mandato, o resto esta como foi apresentado por ele. Mas concordo que a relação entre Professor e Parentesco está estranha. Também fiquei em dúvida em relação às cardinalidades das relações Professor e Afastamento (Relata)
e Parecer e Afastamento, como estas são exclusivas de afastamentos internacionais, nos lugares em que a cardinalidade é 1, deveria ser na verdade 0..1?}
