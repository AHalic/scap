...
\sophie{Explicado melhor na Seção~\ref{sec-fundteo-framework-next} sobre Next.js ser fullstack}
...
\sophie{Mudei a ordem dos paragrafos e expliquei melhor a separação de front e back}
...
\sophie{Explicado na Seção~\ref{sec-projeto-arquitetura}}
