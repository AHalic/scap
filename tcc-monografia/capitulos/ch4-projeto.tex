...
\vitor{A Seção~\ref{sec-projeto-estrutura} não mostra a arquitetura, mas sim a estrutura do sistema pra implementação. A arquitetura teria que ser mostrada antes dos modelos FrameWeb, como é feito no documento de especificação de projeto.}
...
O sistema roda em um único servidor, mas podemos separar lógicamente os pacotes sendo a Camada de Apresentação
