...
\vitor{E a Seção~\ref{sec-fundteo-framework-ts}? Vide também comentário lá na Seção~\ref{sec-fundteo-framework-ts}, pois ela acabou ficando muito pequena, talvez seja melhor não ter mesmo, incorporar em outra seção.}
