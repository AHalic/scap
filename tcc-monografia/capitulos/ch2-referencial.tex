...
\vitor{E a Seção? Vide também comentário lá na Seção, pois ela acabou ficando muito pequena, talvez seja melhor não ter mesmo, incorporar em outra seção.}
\sophie{Achei de fato melhor incorporar na Seção~\ref{sec-fundteo-framework-next}}.
...
\vitor{Seria interessante colocar uma breve seção sobre Projeto de Sistemas aqui, entre requisitos e Web. Quando você fala de FrameWeb mais à frente, você menciona a fase de projeto de sistemas.}


\subsection{Projeto de Sistemas}
\label{subsec-fundteo-engsoft-projsis}

A fase Projeto de Sistemas ocorre após a Especificação de Software, e tem como objetivo
...
Dessa forma, o resultado do processo de projeto de arquitetura é um modelo de arquitetura que descreve como o sistema
...
\vitor{Veja se consegue na bibliografia da disciplina de banco de dados alguma publicação que diga o que você menciona acima (o livro do Elmasri \& Navathe talvez diga?) e adicione a referência bibliográfica. Se não vai ficar como sendo sua opinião (apesar de ser uma opinião popular). No trabalho de Mestrado do Félix ele provavelmente disse algo parecido com o parágrafo acima e deve ter citado alguém pra embasar, se quiser dar uma olhada: \url{http://www.inf.ufes.br/~vitorsouza/wp-content/papercite-data/pdf/zanetti-msc20.pdf}}
\sophie{Adicionada referência bibliográfica.}
